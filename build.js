(() => {
  ...
  var sr = (i, t, l) => new Promise((w2, U) => {
    ...
    }, A = (q) => q.done ? w2(q.value) : Promise.resolve(q.value).then(p, S);
  ...
  var ue = class {
    constructor(t, l, w2) {
      ...
      b(this, "g", 255);
      b(this, "b", 255);
      this.r = z(t, 0, 255), this.g = z(l, 0, 255), this.b = z(w2, 0, 255);
    }
    static fromArray(t) {
...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  rects.forEach((rectangle) => {
    const { size: size2, position, bgColor } = rectangle;
    const { w: w2, h: h2 } = size2;
    const { x, y } = position;
    const r = bgColor[0];
    const g = bgColor[1];
    const b2 = bgColor[2];
